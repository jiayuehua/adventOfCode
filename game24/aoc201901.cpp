...
//const auto r0_def = r4 >> r1 >> r5;
//const auto r1_def = (r2 >> r3) | (r3 >> r2);
//const auto r2_def = (r4 >> r4) | (r5 >> r5);
//const auto r3_def = (r4 >> r5) | (r5 >> r4);
//const auto r4_def = lit("a");
//const auto r5_def = lit("b");

//BOOST_SPIRIT_DEFINE(r0, r1, r2, r3, r4, r5)
